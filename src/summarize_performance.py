...
def parse_args():
    ...
    parser.add_argument("-l", "--log_path", type=str,
                        ...
                        required=False,
			default="./summarize_performance.log")
    parser.add_argument("-t", "--treatments", type=str,
                        help="Enable flags",
                        required=False,
			default="Almond Avocado Barley Broccoli Oats Walnut")
...
def main(args):
    ...
    treatments = args.treatments.strip().split(' ')
